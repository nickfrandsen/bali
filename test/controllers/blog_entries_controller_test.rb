...
class BlogEntriesControllerTest < ActionController::TestCase
  ...
  test "should create blog_entry" do
    assert_difference('BlogEntry.count') do
      post :create, blog_entry: { author: @blog_entry.author, content: @blog_entry.content, permalink: @blog_entry.permalink, title: @blog_entry.title }
    end
  ...
  test "should update blog_entry" do
    patch :update, id: @blog_entry, blog_entry: { author: @blog_entry.author, content: @blog_entry.content, permalink: @blog_entry.permalink, title: @blog_entry.title }
    assert_redirected_to blog_entry_path(assigns(:blog_entry))
  end
